...
$$
r_k = \frac{\sum_\limits{t = k+1}^n (X_t-\bar{X})(X_{t-k}-\bar{X})}{\sum_\limits{t = 1}^n(X_t-\bar{X})^2}
$$
...
$$
\pi_j=\frac{\rho_j-\sum_\limits{k = 1}^{j-1}\pi_{j-1, k}\rho_{j-k}}{1-\sum_\limits{k = 1}^{j-1}\pi_{j-1, k}\rho_k}
$$
...
Esta prueba permite probar en forma conjunta que todos los coeficientes de autocorrelación son simultáneamente iguales a cero, esto es que son independientes. La prueba está definida como
