...
También conocida como la _función de autocorrelación_ (ACF), la cual es una medida de la relación para los valores de la serie respecto a los valores de esta misma, observados $k-t$ unidades de tiempo.
...
$$
\pi_j=cor(X_j,X_{j-k}|X_{j-1},X_{j-2},...X_{j-k-1})
$$
...
Entonces si $LB$ excede el valor crítico de la tabla $Ji$ cuadrada al nivel de significancia seleccionadao, no se acepta la hipótesis de que todos los coeficientes de autocorrelación son iguales a cero, por lo tanto al menos algunos de ellos deben ser diferentes de cero.
